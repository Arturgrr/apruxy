...
// src/commands/economy/corals.ts
var corals_exports = {};
__export(corals_exports, {
  default: () => BotCommand
});
module.exports = __toCommonJS(corals_exports);
...
BotCommand.data = new import_discord.SlashCommandBuilder().setName("corals").setNameLocalizations({
  "pt-BR": "corais"
}).setDescription("See how many corals you or others have").setDescriptionLocalizations({
  "pt-BR": "Veja quantos corais voc\xEA, ou outras pessoas tem"
}).addUserOption(
  new import_discord.SlashCommandUserOption().setName("user").setNameLocalizations({
    "pt-BR": "usu\xE1rio"
  }).setDescription("The user to see how many corals they have").setDescriptionLocalizations({
    "pt-BR": "O usu\xE1rio para ver quantos corais ele tem"
  }).setRequired(false)
);
